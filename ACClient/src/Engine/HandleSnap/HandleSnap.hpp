 ...
 * make the user start the process as administrator (BAD IDEA) and then we would have capability to get info for every
 * process - but that's more complication than is needed for a thesis), we will not be able to catch all processes. This
 * should be rectified in production or mitigated through the use of a kernel driver to ensure system integrity.
 */
