...
{
    const auto bufferSize = WideCharToMultiByte(CP_UTF8, 0u, aView.data(), (pico::Int32)(aView.size()),
...
pico::UnicodeString pico::shared::Util::ToUTF16(pico::StringView aView)
{
    const auto bufferSize =
        MultiByteToWideChar(CP_UTF8, 0u, aView.data(), (pico::Int32)(aView.size()), nullptr, 0);
