            ...
            union
            {
                ...
                struct
                {
                    struct /* bitfield */
                    {
                        ...
                        /* 0x06d4 */ unsigned short BpbTrappedBpbStateReserved : 3;    /* bit position: 5 */
